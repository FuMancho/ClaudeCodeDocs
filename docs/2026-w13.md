Releases [v2.1.83 → v2.1.85](/en/changelog#2-1-83 /en/changelog#2-1-83)6 features · March 23–27
...
[Permission modes guide](/en/permission-modes /en/permission-modes)
...
[Computer use guide](/en/desktop#let-claude-use-your-computer /en/desktop#let-claude-use-your-computer)
...
[Auto-fix pull requests](/en/claude-code-on-the-web#auto-fix-pull-requests /en/claude-code-on-the-web#auto-fix-pull-requests)
...
[Fullscreen guide](/en/fullscreen#search-and-review-the-conversation /en/fullscreen#search-and-review-the-conversation)
...
[PowerShell tool docs](/en/tools-reference#powershell-tool /en/tools-reference#powershell-tool)
...
[Hooks reference](/en/hooks /en/hooks)
