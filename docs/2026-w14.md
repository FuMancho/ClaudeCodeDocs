Releases [v2.1.86 → v2.1.91](/en/changelog#2-1-86 /en/changelog#2-1-86)5 features · March 30 – April 3
...
[Computer use guide](/en/computer-use /en/computer-use)
...
[Commands reference](/en/commands /en/commands)
...
[Fullscreen rendering](/en/fullscreen /en/fullscreen)
...
[MCP reference](/en/mcp#raise-the-limit-for-a-specific-tool /en/mcp#raise-the-limit-for-a-specific-tool)
...
[Plugins reference](/en/plugins-reference#file-locations-reference /en/plugins-reference#file-locations-reference)
