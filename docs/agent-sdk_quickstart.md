...
| `bypassPermissions` | Runs every tool without prompting, unless an explicit [`ask` rule](./agent-sdk_permissions.md#how-permissions-are-evaluated) matches | Sandboxed CI, fully trusted environments |
