...
* **Programmatically**: use the `agents` parameter in your `query()` options ([TypeScript](./agent-sdk_typescript.md#agentdefinition), [Python](./agent-sdk_python.md#agentdefinition))
...
In the Python SDK, these field names use camelCase to match the wire format. See the [`AgentDefinition` reference](./agent-sdk_python.md#agentdefinition) for details.
