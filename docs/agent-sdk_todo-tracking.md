...
Before running these examples, install the Claude Agent SDK by following the [quickstart](./agent-sdk_quickstart.md).
...
See [Handle the result](./agent-sdk_agent-loop.md#handle-the-result) for the result subtypes.
