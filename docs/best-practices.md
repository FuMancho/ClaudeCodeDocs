...
| --- | --- | --- |
| **Provide verification criteria** | *”implement a function that validates email addresses"* | *"write a validateEmail function. example test cases: [[email protected]](/cdn-cgi/l/email-protection#a4d1d7c1d6e4c1dcc5c9d4c8c18ac7cbc9) is true, invalid is false, [[email protected]](/cdn-cgi/l/email-protection#d5a0a6b0a795fbb6bab8) is false. run the tests after implementing”* |
