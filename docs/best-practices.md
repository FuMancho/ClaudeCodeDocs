...
| --- | --- | --- |
| **Provide verification criteria** | *”implement a function that validates email addresses"* | *"write a validateEmail function. example test cases: hello@anthropic.com is true, invalid is false, hello@anthropic.com is false. run the tests after implementing”* |
