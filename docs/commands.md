...
Claude Code also includes [bundled skills](./skills.md#bundled-skills) like `/simplify`, `/batch`, `/debug`, and `/loop` that appear alongside built-in commands when you type `/`. To create your own commands, see [skills](./skills.md).
...
| `/remote-env` | Configure the default remote environment for [web sessions started with `--remote`](./claude-code-on-the-web.md#environment-configuration) |
