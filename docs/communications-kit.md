...
### [​](#the-announcement "#the-announcement") The announcement
...
### [​](#executive-sponsor-variant "#executive-sponsor-variant") Executive sponsor variant
...
### [​](#pilot-group-variant "#pilot-group-variant") Pilot group variant
...
### [​](#champion-recruitment-dm "#champion-recruitment-dm") Champion recruitment DM
...
## [​](#tips-and-tricks-campaign "#tips-and-tricks-campaign") Tips and tricks campaign
...
| Model | Best for |
| --- | --- |
| Fable 5 | The hardest, longest-running tasks. Opt-in only: select it with `/model fable`. Cybersecurity or biology content [falls back to Opus](./model-config#automatic-model-fallback "._model-config#automatic-model-fallback".md) |
...
### [​](#control-and-safety "#control-and-safety") Control and safety
...
### [​](#automate-your-workflows "#automate-your-workflows") Automate your workflows
...
### [​](#day-to-day-development "#day-to-day-development") Day-to-day development
...
### [​](#share-and-scale "#share-and-scale") Share and scale
...
### [​](#security-and-admin "#security-and-admin") Security and admin
...
### [​](#faq-responses "#faq-responses") FAQ responses
...
| “Can it see my whole repo?” | It reads what you give it access to. File reads inside your working directory don’t prompt; permission prompts gate edits, non-read-only shell commands, and file-tool reads outside that directory. A built-in set of read-only shell commands such as `ls` and `cat` runs without prompting; restrict it with [sandbox `denyRead` rules](./sandboxing#filesystem-isolation "._sandboxing#filesystem-isolation".md). [Permissions →](./permissions "._permissions".md) |
