...
See [How scheduled tasks run](#how-scheduled-tasks-run #how-scheduled-tasks-run) for details on missed runs and catch-up behavior for local tasks.
...
| Frequency | How often the task runs. See [frequency options](#frequency-options #frequency-options) below. |
