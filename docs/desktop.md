...
* [Visual diff review](#review-changes-with-diff-view #review-changes-with-diff-view) with inline comments
* [Live app preview](#preview-your-app #preview-your-app) with dev servers
* [Computer use](#let-claude-use-your-computer #let-claude-use-your-computer) to open apps and control your screen on macOS and Windows
* [GitHub PR monitoring](#monitor-pull-request-status #monitor-pull-request-status) with auto-fix and auto-merge
* [Parallel sessions](#work-in-parallel-with-sessions #work-in-parallel-with-sessions) with automatic Git worktree isolation
* [Dispatch](#sessions-from-dispatch #sessions-from-dispatch) integration: send a task from your phone, get a session here
* [Scheduled tasks](./desktop-scheduled-tasks.md) that run Claude on a recurring schedule
* [Connectors](#connect-external-tools #connect-external-tools) for GitHub, Slack, Linear, and more
* Local, [SSH](#ssh-sessions #ssh-sessions), and [cloud](#run-long-running-tasks-remotely #run-long-running-tasks-remotely) environments

New to Desktop? Start with [Get started](./desktop-quickstart.md) to install the app and make your first edit.

This page covers [working with code](#work-with-code #work-with-code), [computer use](#let-claude-use-your-computer #let-claude-use-your-computer), [managing sessions](#manage-sessions #manage-sessions), [extending Claude Code](#extend-claude-code #extend-claude-code), and [configuration](#environment-configuration #environment-configuration). It also includes a [CLI comparison](#coming-from-the-cli #coming-from-the-cli) and [troubleshooting](#troubleshooting #troubleshooting).
...
Type what you want Claude to do and press **Enter** to send. Claude reads your project files, makes changes, and runs commands based on your [permission mode](#choose-a-permission-mode #choose-a-permission-mode). You can interrupt Claude at any point: click the stop button or type your correction and press **Enter**. Claude stops what it’s doing and adjusts based on your input.
...
Session isolation requires [Git](https://git-scm.com/downloads https://git-scm.com/downloads). Most Macs include Git by default. Run `git --version` in Terminal to check. On Windows, Git is required for the Code tab to work: [download Git for Windows](https://git-scm.com/downloads/win https://git-scm.com/downloads/win), install it, and restart the app. If you run into Git errors, try a Cowork session to help troubleshoot your setup.
...
| Computer use | [Enable via `/mcp`](./computer-use.md) on macOS | [App and screen control](#let-claude-use-your-computer #let-claude-use-your-computer) on macOS and Windows |
...
### [​](#cowork-tab-unavailable-on-intel-macs #cowork-tab-unavailable-on-intel-macs) Cowork tab unavailable on Intel Macs
