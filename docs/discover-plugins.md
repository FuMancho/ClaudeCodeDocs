...
* A **Context cost** estimate so you can see how many tokens the plugin will add to your [context window](./features-overview.md#understand-context-costs) every turn (Claude Code v2.1.143 and later)
