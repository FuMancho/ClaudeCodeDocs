...
Fullscreen rendering is an opt-in [research preview](#research-preview "#research-preview") and requires Claude Code v2.1.89 or later. Run `/tui fullscreen` to switch in your current conversation, or set `CLAUDE_CODE_NO_FLICKER=1` on versions before v2.1.110. Behavior may change based on feedback.
...
| `Cmd`-click to open a URL | Click the URL | [Use the mouse](#use-the-mouse "#use-the-mouse") |
