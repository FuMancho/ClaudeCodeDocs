...
* This quickstart method is only available for direct Claude API users. If
  ...
  with Amazon Bedrock and Google Cloud](#using-with-amazon-bedrock-and-google-cloud "#using-with-amazon-bedrock-and-google-cloud")
  section.
...
#### [​](#for-google-cloud’s-agent-platform "#for-google-cloud’s-agent-platform") For Google Cloud’s Agent Platform:
