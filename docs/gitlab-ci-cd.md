...
To run on AWS Bedrock or Google Vertex AI instead of the Claude API, see the [Using with AWS Bedrock & Google Vertex AI](#using-with-aws-bedrock--google-vertex-ai #using-with-aws-bedrock--google-vertex-ai) section below for authentication and environment setup.
...
## [​](#using-with-aws-bedrock-&-google-vertex-ai #using-with-aws-bedrock-&-google-vertex-ai) Using with AWS Bedrock & Google Vertex AI
...
### [​](#aws-bedrock-job-example-oidc #aws-bedrock-job-example-oidc) AWS Bedrock job example (OIDC)
