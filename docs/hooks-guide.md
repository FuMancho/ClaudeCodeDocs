...
* `"type": "agent"`: multi-turn verification with tool access. See [Agent-based hooks](#agent-based-hooks #agent-based-hooks).
...
### [​](#stop-hook-runs-forever #stop-hook-runs-forever) Stop hook runs forever
