...
The SDK also supports [programmatic sandbox configuration](./typescript.md#sandboxsettings) for command execution.
...
* [TypeScript SDK - Sandbox Settings](./typescript.md#sandboxsettings) - Configure sandbox programmatically
