...
The SDK also supports [programmatic sandbox configuration](./typescript.md#sandbox-settings) for command execution.
...
* [TypeScript SDK - Sandbox Settings](./typescript.md#sandbox-settings) - Configure sandbox programmatically
