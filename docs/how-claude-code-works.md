...
This guide covers the core architecture, built-in capabilities, and [tips for working effectively](#work-effectively-with-claude-code #work-effectively-with-claude-code). For step-by-step walkthroughs, see [Common workflows](./common-workflows.md). For extensibility features like skills, MCP, and hooks, see [Extend Claude Code](./features-overview.md).
