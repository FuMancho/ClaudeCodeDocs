...
* [Permission modes](./overview.md): the Proactive style mirrors auto mode without changing your permission mode
* [Plugins](./plugins.md): package and distribute output styles alongside skills, hooks, and agents
* [Debug your configuration](./overview.md): diagnose why an output style isn’t taking effect
