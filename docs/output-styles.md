...
### [​](#output-styles-vs-claude-md-vs-—append-system-prompt #output-styles-vs-claude-md-vs-—append-system-prompt) Output Styles vs. CLAUDE.md vs. —append-system-prompt
...
### [​](#output-styles-vs-agents #output-styles-vs-agents) Output Styles vs. [Agents](./sub-agents.md)
...
### [​](#output-styles-vs-skills #output-styles-vs-skills) Output Styles vs. [Skills](./skills.md)
