...
* **Learning**: Collaborative, learn-by-doing mode where Claude will not only
  ...
  pieces of code yourself. Claude Code will add `(human)` markers in your
