...
Each plugin entry needs at minimum a `name` and `source` (where to fetch it from). See the [full schema](#marketplace-schema "#marketplace-schema") below for all available fields.
