...
Make your skill dynamic by accepting user input. The `$ARGUMENTS` markers captures any text the user provides after the skill name.Update your `SKILL.md` file:
...
Once your plugin is listed, you can have your own CLI prompt Claude Code users to install it. See [Recommend your plugin from your CLI](./overview.md).
