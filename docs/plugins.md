...
Make your skill dynamic by accepting user input. The `$ARGUMENTS` variable captures any text the user provides after the skill name.Update your `SKILL.md` file:
