...
Routines are available on Pro, Max, Team, and Enterprise plans with [Claude Code on the web](./claude-code-on-the-web.md) enabled. Create and manage them at claude.ai/code/routines, or from the CLI with `/schedule`.
