...
For the broader security model, see [Security](./security.md). For Agent SDK deployments, see [Secure deployment](./agent-sdk_secure-deployment.md).
...
* [Secure deployment](./agent-sdk_secure-deployment.md): isolation guidance for Agent SDK applications
