...
* **Computer use**: when Claude opens apps and controls your screen, it runs on your actual desktop rather than in an isolated environment. Per-app permission prompts gate each application. See [computer use in the CLI](./overview.md) or [computer use in Desktop](./desktop.md#let-claude-use-your-computer).
