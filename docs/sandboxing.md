...
## [​](#why-sandboxing-matters #why-sandboxing-matters) Why sandboxing matters
...
### [​](#enable-sandboxing #enable-sandboxing) Enable sandboxing
...
#### [​](#granting-subprocess-write-access-to-specific-paths #granting-subprocess-write-access-to-specific-paths) Granting subprocess write access to specific paths
...
## [​](#security-benefits #security-benefits) Security benefits

### [​](#protection-against-prompt-injection #protection-against-prompt-injection) Protection against prompt injection
...
### [​](#reduced-attack-surface #reduced-attack-surface) Reduced attack surface
...
### [​](#transparent-operation #transparent-operation) Transparent operation
...
Users should be aware of potential risks that come from allowing broad domains like `github.com` that may allow for data exfiltration. Also, in some cases it may be possible to bypass the network filtering through [domain fronting](https://en.wikipedia.org/wiki/Domain_fronting https://en.wikipedia.org/wiki/Domain_fronting).
...
## [​](#how-sandboxing-relates-to-permissions #how-sandboxing-relates-to-permissions) How sandboxing relates to permissions
...
### [​](#integration-with-existing-security-tools #integration-with-existing-security-tools) Integration with existing security tools
...
For implementation details and source code, visit the [GitHub repository](https://github.com/anthropic-experimental/sandbox-runtime https://github.com/anthropic-experimental/sandbox-runtime).
...
## [​](#what-sandboxing-does-not-cover #what-sandboxing-does-not-cover) What sandboxing does not cover
