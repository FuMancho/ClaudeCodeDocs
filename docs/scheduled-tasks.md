...
* skills withheld from Claude by a [`skillOverrides`](./skills.md#override-skill-visibility-from-settings) setting or a `Skill` [deny rule](./skills.md#restrict-claude%E2%80%99s-skill-access)
