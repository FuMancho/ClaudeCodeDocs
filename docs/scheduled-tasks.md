...
In [self-paced mode](#let-claude-choose-the-interval "#let-claude-choose-the-interval"), Claude can also end the loop on its own by not scheduling the next wakeup once the task is provably complete. Loops on a fixed interval keep running until you stop them or [seven days elapse](#seven-day-expiry "#seven-day-expiry").
