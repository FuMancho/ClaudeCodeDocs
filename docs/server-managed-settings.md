...
To configure the [auto mode](./overview.md#eliminate-prompts-with-auto-mode) classifier so it knows which repos, buckets, and domains your organization trusts:
