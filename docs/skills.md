...
For more details on `settingSources`/`setting_sources`, see the [TypeScript SDK reference](./typescript.md#setting-source) or [Python SDK reference](./python.md#setting-source).
...
* [Slash Commands in the SDK](./slash-commands.md): User-invoked commands
