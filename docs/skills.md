...
```text
For more details on `settingSources`/`setting_sources`, see the [TypeScript SDK reference](./typescript.md#settingsource) or [Python SDK reference](./python.md#settingsource).
