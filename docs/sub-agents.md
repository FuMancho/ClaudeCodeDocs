...
* In [non-interactive mode](./headless.md) and the [Agent SDK](./agent-sdk_overview.md), set [`CLAUDE_AGENT_SDK_DISABLE_BUILTIN_AGENTS=1`](./env-vars.md) to remove all built-in types and supply only your own.
