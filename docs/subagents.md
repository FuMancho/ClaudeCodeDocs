...
* **Programmatically**: use the `agents` parameter in your `query()` options ([TypeScript](./typescript.md#agent-definition), [Python](./python.md#agent-definition))
...
## [​](#creating-subagents #creating-subagents) Creating subagents
...
## [​](#invoking-subagents #invoking-subagents) Invoking subagents
...
## [​](#detecting-subagent-invocation #detecting-subagent-invocation) Detecting subagent invocation
...
## [​](#resuming-subagents #resuming-subagents) Resuming subagents
...
### [​](#windows-long-prompt-failures #windows-long-prompt-failures) Windows: long prompt failures
