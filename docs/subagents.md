...
* **Programmatically**: use the `agents` parameter in your `query()` options ([TypeScript](./typescript.md#agentdefinition), [Python](./python.md#agentdefinition))
...
In the Python SDK, these field names use camelCase to match the wire format. See the [`AgentDefinition` reference](./python.md#agentdefinition) for details.
