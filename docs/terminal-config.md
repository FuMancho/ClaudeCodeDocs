...
When you paste more than 10,000 characters into the prompt, Claude Code collapses the input to a `[Pasted text]`  so the input box stays usable. The full content is still sent to Claude when you submit.
