...
source ~/.bashrc
```text
Then try `claude` again. For more details, see [fix your PATH](./troubleshoot-install.md#verify-your-path).
...
```text
Close PowerShell, open a new window, and try `claude` again. See [verify your PATH](./troubleshoot-install.md#verify-your-path) for more details.
