...
| `TaskWrite` | Manages the session task checklist. Available in non-interactive mode and the [Agent SDK](./headless.md); interactive sessions use TaskCreate, TaskGet, TaskList, and TaskUpdate instead | No |
