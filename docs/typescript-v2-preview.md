The V2 interface is an **unstable preview**. APIs may change based on feedback before becoming stable. Some features like session forking are only available in the [V1 SDK](./typescript.md).
...
Not all V1 features are available in V2 yet. The following require using the [V1 SDK](./typescript.md):
...
Share your feedback on the V2 interface before it becomes stable. Report issues and suggestions through [GitHub Issues](https://github.com/anthropics/claude-code/issues https://github.com/anthropics/claude-code/issues).
