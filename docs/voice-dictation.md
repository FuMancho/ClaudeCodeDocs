...
## [​](#record-a-prompt #record-a-prompt) Record a prompt
...
To skip the warmup, [rebind to a modifier combination](#rebind-the-push-to-talk-key #rebind-the-push-to-talk-key) like `meta+k`. Modifier combos start recording on the first keypress.
...
## [​](#rebind-the-push-to-talk-key #rebind-the-push-to-talk-key) Rebind the push-to-talk key
