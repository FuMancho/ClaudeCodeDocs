...
Releases [v2.1.83 → v2.1.85](./changelog.md#2-1-83 "/docs/en/changelog#2-1-83")6 features · March 23–27
...
[Permission modes guide](./permission-modes.md "/docs/en/permission-modes")
...
[Computer use guide](./desktop.md#let-claude-use-your-computer "/docs/en/desktop#let-claude-use-your-computer")
...
[Fullscreen guide](./fullscreen.md#search-and-review-the-conversation "/docs/en/fullscreen#search-and-review-the-conversation")
...
[PowerShell tool docs](./tools-reference.md#powershell-tool "/docs/en/tools-reference#powershell-tool")
...
[Hooks reference](./hooks.md "/docs/en/hooks")
...
[Full changelog for v2.1.83–v2.1.85 →](./changelog.md#2-1-83 "/docs/en/changelog#2-1-83")