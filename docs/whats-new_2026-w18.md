...
Releases [v2.1.120 → v2.1.126](./changelog.md#2-1-120 "/docs/en/changelog#2-1-120")4 features · April 27 – May 1
...
[CLI reference](./cli-reference.md#cli-commands "/docs/en/cli-reference#cli-commands")
...
[CLI reference](./cli-reference.md "/docs/en/cli-reference")
...
[Sessions: use the session picker](./sessions.md#use-the-session-picker "/docs/en/sessions#use-the-session-picker")
...
New [`claude ultrareview`](./ultrareview.md "/docs/en/ultrareview") subcommand runs `/ultrareview` non-interactively from CI or scripts: prints findings to stdout (`—json` for raw output) and exits 0 on completion or 1 on failure
...
[Full changelog for v2.1.120–v2.1.126 →](./changelog.md#2-1-120 "/docs/en/changelog#2-1-120")