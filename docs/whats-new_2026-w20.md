...
Releases [v2.1.139 → v2.1.142](./changelog#2-1-139 "._changelog#2-1-139".md)3 features · May 11–15
...
[Agent view](./agent-view "._agent-view".md)
...
[Fast mode on Opus 4.7](./fast-mode#understand-the-cost-tradeoff "._fast-mode#understand-the-cost-tradeoff".md)
