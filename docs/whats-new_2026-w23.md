...
Releases [v2.1.158 → v2.1.165](./changelog.md#2-1-158)4 features · June 1–5
...
```
[Enable auto mode on third-party providers](./permission-modes.md#enable-auto-mode-on-bedrock-agent-platform-or-foundry)
...
```
[Protected paths](./permission-modes.md#protected-paths)
...
> /plugin list --enabled
```
[Plugin commands](./plugins-reference.md#plugin-list)
...
```
[Decide what to enforce](./admin-setup.md#decide-what-to-enforce)
