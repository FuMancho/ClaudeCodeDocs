...
Releases [v2.1.185 → v2.1.193](./changelog#2-1-185 "._changelog#2-1-185".md)2 features · June 22–26
...
[Authenticate from the command line](./mcp#authenticate-from-the-command-line "._mcp#authenticate-from-the-command-line".md)
...
[Shell mode with the ! prefix](./interactive-mode#shell-mode-with-prefix "._interactive-mode#shell-mode-with-prefix".md)
...
[Full changelog for v2.1.185–v2.1.193 →](./changelog#2-1-185 "._changelog#2-1-185".md)