...
Releases [v2.1.202 → v2.1.206](./changelog#2-1-202 "._changelog#2-1-202".md)2 features · July 6–10
...
[Browse external sites](./desktop#browse-external-sites "._desktop#browse-external-sites".md)
...
[Full changelog for v2.1.202–v2.1.206 →](./changelog#2-1-202 "._changelog#2-1-202".md)