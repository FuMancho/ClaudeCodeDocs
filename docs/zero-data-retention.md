...
ZDR is not included in the standard Claude for Enterprise plan and cannot be enabled from your admin settings. It is available to qualified accounts and requires separate enablement by Anthropic. If your organization requires ZDR, [contact sales](https://www.anthropic.com/contact-sales?utm_source=claude_code&utm_medium=docs&utm_content=zero_data_retention_request "https://www.anthropic.com/contact-sales?utm_source=claude_code&utm_medium=docs&utm_content=zero_data_retention_request") or your Anthropic account team to confirm eligibility.
...
### [​](#route-claude-code-traffic-to-your-zdr-organization "#route-claude-code-traffic-to-your-zdr-organization") Route Claude Code traffic to your ZDR organization
...
### [​](#what-zdr-covers "#what-zdr-covers") What ZDR covers

ZDR covers model inference calls made through Claude Code on Claude for Enterprise. When you use Claude Code in your terminal, the prompts you send and the responses Claude generates are not retained by Anthropic. This applies to every model available to ZDR organizations. Some models require data retention and are not available under ZDR; see [Model availability under ZDR](#model-availability-under-zdr "#model-availability-under-zdr").
...
## [​](#features-disabled-under-zdr "#features-disabled-under-zdr") Features disabled under ZDR
...
| [Cloud sessions](./desktop#cloud-sessions "._desktop#cloud-sessions".md) from the Desktop app | Requires persistent session data that includes prompts and completions. |
| [Artifacts](./artifacts "._artifacts".md) | Requires storing published page content on Anthropic-operated infrastructure. |
| Feedback submission (`/feedback`, `/bug`, `/share`) | Submitting feedback sends conversation data to Anthropic. |
| [Remote Control](./remote-control "._remote-control".md) | Stores the session transcript on Anthropic servers to sync the conversation across devices. |
...
## [​](#data-retention-for-policy-violations "#data-retention-for-policy-violations") Data retention for policy violations
...
## [​](#request-zdr "#request-zdr") Request ZDR

To request ZDR for Claude Code on Claude for Enterprise, [contact sales](https://www.anthropic.com/contact-sales?utm_source=claude_code&utm_medium=docs&utm_content=zero_data_retention_request "https://www.anthropic.com/contact-sales?utm_source=claude_code&utm_medium=docs&utm_content=zero_data_retention_request") or your Anthropic account team. Your account team will submit the request internally, and Anthropic will review and enable ZDR on your organization after confirming eligibility. All enablement actions are audit-logged.
